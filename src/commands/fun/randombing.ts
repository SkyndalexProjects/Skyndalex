...
export async function run(
    ...
    const response = await fetch("https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=50")
    ...
    const fullTs = parseBingDate(randomImage.startdate, randomImage.fullstartdate);
