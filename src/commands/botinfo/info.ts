import {
    ...
    type ChatInputCommandInteraction, ContainerBuilder,
    MediaGalleryBuilder,
    MessageFlags, SeparatorBuilder, SeparatorSpacingSize,
    SlashCommandBuilder, TextDisplayBuilder, ActionRowBuilder, version
} from "discord.js";
...
export async function run(
    ...
    const actionRow = new ActionRowBuilder<ButtonBuilder>()
        .addComponents(addButton, websiteButton, dashboard);
