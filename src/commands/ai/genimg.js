...
import { AttachmentBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, SlashCommandBuilder } from 'discord.js';
...
export async function run(client, interaction) {
    ...
    const taskId = `${interaction.guild?.id}-${interaction.user.id}-${Date.now()}`;
...
export const data = new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName('input').setDescription('Input for the AI').setRequired(true));
